    ...
    <div className="relative w-full min-h-screen overflow-hidden flex flex-col">
      ...
      <nav className="relative z-20 w-full bg-[#B8955C] py-6 px-8">
        <ul className="flex justify-center items-center gap-16 text-white font-inria-serif">
          ...
          <li>
            <a href="/miriam/education" className="text-xl text-black">
              Educacion
            </a>
          </li>
          <li>
        ...
        <div className="relative z-10 w-full max-w-6xl mt-40">
          ...
          <div className="relative mb-8">
            ...
            <div className="absolute -top-44 left-32 z-20">
              <Image
                src="/images/miriam/education/hat.png"
                alt="Graduation Hat"
                width={300}
                height={300}
            ...
            <div className="absolute -top-28 right-32 z-20">
              <Image
                src="/images/miriam/education/parthenon.png"
                alt="Parthenon"
                width={280}
                height={140}
                className="object-contain"
            ...
            <div className="flex items-center justify-between gap-8 mt-8">
              ...
              <div className="flex-1 relative">
                <Image
                  src="/images/miriam/education/line.png"
                  alt="Timeline"
                  width={600}
                  height={50}
              ...
              <div className="flex-1 relative">
                ...
                <span className="absolute top-1/2 -translate-y-10 -mt-5 text-white font-inria-serif text-2xl md:text-4xl" style={{ right: '-4.2ch' }}>
                  Actualidad
                </span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-2">
            ...
            <div className="text-center">
              <h2 className="text-white font-inria-serif text-4xl mb-4">
                SECUNDARIA ORT ARGENTINA
              </h2>
              <p className="text-white font-inria-serif text-xl md:text-3xl mb-6">
                Bachiller en Tecnología<br/>
                de la Información y las<br/>
                Comunicaciones
              </p>
              <div className="flex justify-center mt-8">
                <Image
                  src="/images/miriam/education/ort.png"
                  alt="ORT Argentina Logo"
                  width={320}
                  height={140}
                  className="object-contain"
                />
            ...
            <div className="text-center">
              ...
              <p className="text-white font-inria-serif text-3xl mb-4">
                Facultad de Derecho
              </p>
              <div className="flex justify-center mt-8">
                <Image
                  src="/images/miriam/education/uba.png"
                  alt="UBA Derecho Logo"
                  width={240}
                  height={240}
                  className="object-contain"
                />
